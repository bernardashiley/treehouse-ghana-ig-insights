...
\begin{enumerate}
  ...
  \item \textbf{Your most common high-intent comment is \textquotedblleftlocation/access question\textquotedblright{}} (4.7\% of comments). Replying quickly turns these warm leads into customers.
...
\textbf{Actionable:} Reply to every \textquotedblleftlocation/access question\textquotedblright{} comment within 30 minutes during posting hours — that is your highest-intent signal.
...
\begin{enumerate}
  \item Reply to every high-intent comment within 30 minutes during posting hours (your most common is \textquotedblleftlocation/access question\textquotedblright{}) — these are warm leads.
